...
Compute the critical limit `cl` for a BP-EWMA control chart based on spatial ordinal
patterns (SOP) such that the in-control ARL equals `L0`.
...
#             L1 = arl_sop_bp_ic(
#                 sp_dgp, lam, cl_init, w, reps; chart_choice=chart_choice, refinement=refinement
#             )[1]
#             if verbose
