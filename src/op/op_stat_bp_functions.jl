...
# Function to compute critical values -> 
function crit_val_op_bp(; chart_choice::Int, w, m, alpha=0.05)
...
# Function to compute test statistics for BP-OP and BL-OP tests 
function stat_op_bp(data; chart_choice::Int, m::Int=3, w=3, ljung_box::Bool=false)
