...
for i in 1:2
  ...
  lines!(ax, sort(dates), ooc_vec, color=:black, label="Typical run")
  lines!(ax, sort(dates), mean_vec, color=:blue, label="Mean of runs")
...
#save("SOP_Ukraine_east_ooc.pdf", fig)
#

# ---------------------------------------------------------#
#         BP statistics with d1 = 1, d2 = 1               #
# ---------------------------------------------------------#
