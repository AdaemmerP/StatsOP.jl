...
```{julia}
stat_sacf(0.1, rand(41, 26, 370), [1, 2], [1, 2]) |> last

cl_sacf(lam, L0, ICSP(41, 26, Normal(0, 1)), 0.088, [1, 2], [1, 2], 1_000; jmin=4, jmax=6, verbose=true)

@btime rl_sacf(0.1, 0.088, ICSP(40, 40, Normal(0, 1)), [1, 2], [1, 2], 1:100, Normal(0, 1))


spatial_sar11 = SAR11((0.1, 0.1, 0.1), 41, 26, Normal(0, 1), nothing, 100)
arl_sacf(0.1, 0.132193, spatial_sar11, [1, 2],  [1, 2], 100)
