...
@btime rl_sop(lam, cl_init, lookup_array_sop, spatial_dgp, 1:1_000, Normal(0, 1), 3, d1_vec, d2_vec)
...
arl_sop(0.1, 0.01009, spatial_sar11, 1, 1, 1_000; chart_choice=3)
```
...
cl_sacf(0.1, 370, ICSP(11, 11, Normal(0, 1)), 0.04 , 2, 1, 1000; jmin=4, jmax=6, verbose=true)
```


```{julia}
stat_sacf(0.1, rand(40, 40, 370), [1, 2], [1, 2]) |> last

cl_sacf(lam, L0, ICSP(40, 40, Normal(0, 1)), 0.088, [1, 2], [1, 2], 1_000; jmin=4, jmax=6, verbose=true)

rl_sacf(0.1, 0.088, ICSP(40, 40, Normal(0, 1)), [1, 2], [1, 2], 1:100, Normal(0, 1))
```