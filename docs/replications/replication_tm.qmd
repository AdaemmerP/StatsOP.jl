...
cl_sop(lam, L0, spatial_dgp, cl_init, d1_vec, d2_vec, 1_000; chart_choice=3, jmin=4, jmax=6, verbose=true)
...
spatial_dgp = SAR1((0.1, 0.1, 0.1, 0.1), 11, 11, Normal(0, 1), nothing, 20)
arl_sop(0.1, 0.03174, spatial_dgp, 1, 1, 1_000; chart_choice=3)
```