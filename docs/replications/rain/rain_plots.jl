...
# load data
mat_all = load("rain_data_2007_08_self_extracted.jld2")["large_array"]
...
lam = [0.1, 1]
d1_d2_crit_ewma = [0.01882]
d1_d2_shewart = [0.092074]
...
lam = [0.1, 1]
clbp = [
    0.0013476 0.0287518; # w = 3, lam = 0.1, 1
    0.0031744 0.0671769  # w = 5, lam = 0.1, 1
]
...
save("Figure3_v4_BP_rain.pdf", fig)
