...
|:------|:----------|:---------------|:-----------|
| Eq. (3) | $\widehat{H}^{(d)}$, permutation entropy | `Shannon()` | $\widehat{H} < cl$ |
| Eq. (3) | $\widehat{H}_{\text{ex}}^{(d)}$, permutation extropy | `ShannonExtropy()` | $\widehat{H}_{\text{ex}} < cl$ |
...
```{julia}
#| output: false
charts2 = [("H", Shannon()), ("Hex", ShannonExtropy()),
